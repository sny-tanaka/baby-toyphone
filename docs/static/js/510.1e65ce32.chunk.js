/*! For license information please see 510.1e65ce32.chunk.js.LICENSE.txt */
      ...
      !(function () {
        ...
        i.prototype = {
          ...
          volume: function () {
            ...
            if (
              (1 === r.length || (2 === r.length && 'undefined' === typeof r[1])
          ...
          rate: function () {
            ...
            for (var i = 0; i < n.length; i++)
              if ((t = o._soundById(n[i]))) {
                ...
                var u = o.seek(n[i]),
                  d =
                    (1e3 * ((o._sprite[t._sprite][0] + o._sprite[t._sprite][1]) / 1e3 - u)) /
                    Math.abs(t._rate);
                (!o._endTimers[n[i]] && t._paused) ||
                  (o._clearTimer(n[i]), (o._endTimers[n[i]] = setTimeout(o._ended.bind(o, t), d))),
                  o._emit('rate', t._id);
              }
            return o;
          },
            ...
            (Howl.prototype.pannerAttr = function () {
              ...
              for (var i = r._getSoundIds(t), u = 0; u < i.length; u++)
                if ((o = r._soundById(i[u]))) {
                  ...
                  d = {
                    coneInnerAngle:
                      'undefined' !== typeof e.coneInnerAngle ? e.coneInnerAngle : d.coneInnerAngle,
                    coneOuterAngle:
                      'undefined' !== typeof e.coneOuterAngle ? e.coneOuterAngle : d.coneOuterAngle,
                    coneOuterGain:
                  ...
                  var s = o._panner;
                  s ||
                    (o._pos || (o._pos = r._pos || [0, 0, -0.5]), n(o, 'spatial'), (s = o._panner)),
